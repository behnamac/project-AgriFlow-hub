...
const emailData = [
  {
    id: 1,
    subject: "Shipping Documents for July 14",
    sender: "Maersk",
  ...
  {
    id: 2,
    subject: "Re: Missing Certificate",
    sender: "Nestlé Logistics",
    attachments: ["Cert_234.pdf"],
    status: "Pending",
    date: "13 Jul 2025",
  ...
  {
    id: 3,
    subject: "Invoice and Packing List - Shipment #7791",
    sender: "Danone Supply Chain",
  ...
  {
    id: 4,
    subject: "Customs Documentation - Batch 445",
    sender: "DHL Global",
    attachments: ["Customs_445.pdf"],
    status: "Error",
    date: "12 Jul 2025",
  ...
  {
    id: 5,
    subject: "Weekly Shipment Documents",
    sender: "FedEx Trade Networks",
    attachments: ["BOL-4801.pdf", "Invoice-4801.pdf", "Certificate-4801.pdf"],
    status: "Processed",
    date: "12 Jul 2025",
    statusColor: "bg-green-100 text-green-700",
  },
...
const DocumentInbox = () => {
  ...
  const filteredEmails = emailData.filter((email) => {
    const matchesStatus = statusFilter === "all" || email.status.toLowerCase().includes(statusFilter.toLowerCase());
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage incoming email documents and attachments</p>
        </div>
      </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-gray-200">
                <TableHead className="font-semibold text-gray-700">Email Subject</TableHead>
            ...
            <TableBody>
              {filteredEmails.map((email) => (
                <TableRow key={email.id} className="border-gray-100 hover:bg-gray-50">
                  <TableCell className="font-medium text-gray-900 max-w-xs truncate">
                    {email.subject}
                  </TableCell>
                  <TableCell className="text-gray-600">{email.sender}</TableCell>
                  <TableCell>
