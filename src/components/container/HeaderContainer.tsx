...
import { LanguageToggle } from "@/components/presentational/LanguageToggle";
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative max-w-xs sm:max-w-md">
          ...
          <Input
            ...
            className="pl-10 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-sm dark:text-white"
          />
        </div>
      </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <span className="hidden sm:inline">{t("user.name")}</span>
            </Button>
          </DropdownMenuTrigger>
